...
//        places= listOf(Place("arone",R.layout.place_view,"kevin", Geometry(GeometryLocation(22.320683, 73.223785))))
...
//        places = listOf(Place("arone","n","kevin", Geometry(GeometryLocation(22.320683, 73.223785))))
...
//            places = listOf(Place("arone","n","kevin", Geometry(GeometryLocation(22.320683, 73.223785))))
    ...
    private fun setUpMaps() {
        mapFragment.getMapAsync { googleMap ->
            ...
            getCurrentLocation {
                ...
                val Ahmedabad = LatLng(23.159107, 72.665158)
                googleMap.addMarker(MarkerOptions().position(Ahmedabad).title("Marker in Ahmedabad"))
    ...
    private fun getNearbyPlaces(location: Location) {
        val apiKey = this.getString(R.string.google_maps_key1)
